  ...
  return (
    <>
      <div style={{ backgroundImage: `url(${HeroImage})` }} className="HeroContainer bg-cover  h-[70vh] bg-no-repeat mb-4 flex-col text-center justify-center items-center ">
        ...
        <Link to={"/menu"}>
          <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center border-2 text-white bg-red-500 rounded-lg hover:bg-gray-500 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
            Order Now
          </a>
        </Link>
      </div>
