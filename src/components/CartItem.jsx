...
import { add, decrementQty, incrementQty, remove } from '../feature/cart/cartSlice'
                    ...
                    <ul className="text-xs text-white space-y-3 mt-4 px-3">
                        ...
                        <li className="flex flex-wrap gap-4 sm:text-lg d-flex justify-between ">
                            ...
                            <span>
                                ...
                                <div className="sm:p-1 inline-block bg-white border border-gray-200 rounded-lg dark:bg-slate-900 dark:border-gray-700" data-hs-input-number>
                                    <div className="flex items-center gap-x-1.5">
                                        <button type="button" className=" size-6 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-md border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" data-hs-input-number-decrement onClick={() => handleDecrement(id)}>
                                        ...
                                        <p className="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 dark:text-white">{qty}</p>
                                        <button type="button" className="size-6 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-md border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" data-hs-input-number-increment onClick={() => handleIncrement(id)}>
                        ...
                        <li className="flex flex-wrap gap-4 sm:text-lg">Total Price <span className="ml-auto">{price}</span></li>
                        <button className='btn btn-sm btn-white bg-red-400 text-light hover:bg-gray-400' onClick={() => handleDelete(cart.id)}>Remove</button>
                    </ul>
                </div>
            </div>
